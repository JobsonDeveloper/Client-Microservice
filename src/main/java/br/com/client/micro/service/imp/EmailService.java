...
import br.com.client.micro.exceptions.ErrorSendingEmailException;
...
public class EmailService implements IEmailService {
    ...
    public void sendMessage(String to, String subject, String body) {
        try {
            ...
            throw new ErrorSendingEmailException("It was not possible send the message to client via E-Mail!");
        }
    }
}
